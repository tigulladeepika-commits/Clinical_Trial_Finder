...
export default function PhysicianPanel({
  ...
  return (
    <>
      {/*
        FIX: the loading spinner previously used className="spinner" which
        relied on a global CSS class that is not guaranteed to be defined.
        The keyframe and spinner styles are now inlined here so the component
        is fully self-contained regardless of globals.css contents.
      */}
      <style>{`
        ...
        .pp-spinner {
          width:  28px;
          height: 28px;
          border: 3px solid var(--gray-100, #f1f5f9);
      ...
      <div style={{ display: "flex", flexDirection: "column", height: "100%", overflow: "hidden" }}>
        ...
        <div style={{ flex: 1, overflow: "auto", padding: "16px" }}>
          ...
          {/* Loading — FIX: replaced className="spinner" with self-contained
              .pp-spinner class defined in the <style> block above */}
          {loading && (
            <div style={{
              display:        "flex",
              ...
              <p style={{ fontSize: 14, margin: 0 }}>Searching physicians…</p>
            </div>
          )}
          ...
          {!loading && !error && searched && physicians.length === 0 && (
            <div style={{
              ...
              <p style={{ fontSize: 13, margin: 0 }}>
                Try increasing the radius or broadening the specialty.
              </p>
            </div>
          )}
