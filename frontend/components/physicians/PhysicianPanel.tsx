  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <span>
            Trial: <strong style={{ color: "#0f172a" }}>{site.nct_id}</strong>
          </span>
          {site.facility && (
            <span>
              Site: <strong style={{ color: "#0f172a" }}>{site.facility}</strong>
            </span>
          )}
        </div>
          ...
          {!loading && !error && !searched && (
            ...
            >
              ...
              <p style={{ fontSize: 14, fontWeight: 600, margin: 0, color: "#64748b" }}>
                Set your radius and press Search
                <br />
                to find physicians near this site
              </p>
